...
* Bugfix [#14](https://github.com/Umoxfo/vscode-w3cvalidation/issues/14) JAVA_HOME plus PATH necessary to run validation
...
## 2.2.1
* Bugfix the extension does not work from last release [#3](https://github.com/Umoxfo/vscode-w3cvalidation/issues/3)
